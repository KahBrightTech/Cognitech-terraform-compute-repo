  ...
  ec2_instances = [
    {
      ...
      name_override    = "MDP-SHR-W-BASTION-01"
      ami_config = {
        os_release_date  = "W22"
    ...
    },
    {
      ...
      name_override = "MDP-SHR-L-ANSIBLE-01"
      ami_config = {
    ...
    },
    {
      ...
      name             = "etl-server"
      backup_plan_name = "${local.aws_account_name}-${local.region_context}-continous-backup"
      name_override    = "MDP-SHR-W-ETL-01"
      ami_config = {
        os_release_date  = "W22"
        os_base_packages = "BASE"
      }
